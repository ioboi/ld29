...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|CSSStyleSheet|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|StyleSheet"
  },
  JSBool: {
    "^": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "CanvasRenderingContext;fillStyle},font},imageSmoothingEnabled},textAlign}",
...
["ld29", "beneaththesurface.dart", , G, {
  "^": "",
  main: [function() {
    G.Sample_init();
    G.Game$(document.getElementById("board")).start$0(0);
  }, "call$0", "main$closure", 0, 0, 0],
  Entity: {
    "^": "Object;x>,dead@"
  },
  ParticleEmitter: {
    "^": "Entity;particles,r,dead:ld29$ParticleEmitter$dead@,deadcount,x,y,dead",
    render$1: function(ctx) {
      var i, t1, p;
      J.set$fillStyle$x(ctx, "#492c11");
      for (i = 0; t1 = this.particles, i < t1.length; ++i) {
        p = t1[i];
        t1 = p.size;
        ctx.fillRect(p.x, p.y, t1, t1);
      }
    },
    tick$0: function() {
      var i, t1, t2, p, i0;
      for (i = 0; t1 = this.particles, t2 = t1.length, i < t2; ++i) {
        if (i < 0)
          return H.ioore(t1, i);
        p = t1[i];
        if (p.ld29$Particle$dead) {
          i0 = i - 1;
          J.removeAt$1$ax(t1, i);
        ...
        t1 = p.tickcount;
        if (t1 <= 0)
          p.ld29$Particle$dead = true;
        p.tickcount = t1 - 1;
      }
      if (this.deadcount === t2)
        this.ld29$ParticleEmitter$dead = true;
    },
    ParticleEmitter$3: function(x, y, particles) {
      var t1, i, t2, t3, t4;
      this.particles = [];
      for (t1 = this.r, i = 0; i < particles; ++i) {
        t2 = this.particles;
        t3 = t1.nextInt$1(50);
        t4 = t1.nextDouble$0();
        t2.push(new G.Particle(t3, t1.nextDouble$0() * -10, t4 * 10 - 5, false, t1.nextInt$1(5), x, y, false));
      }
    },
    static: {ParticleEmitter$: function(x, y, particles) {
        var t1 = new G.ParticleEmitter(null, C.C__JSRandom, false, 0, x, y, false);
        t1.ParticleEmitter$3(x, y, particles);
        return t1;
      }}
  },
  Particle: {
    "^": "Entity;tickcount,velocityY,velocityX,dead:ld29$Particle$dead@,size,x,y,dead",
    render$1: function(ctx) {
      var t1 = this.size;
      J.fillRect$4$x(ctx, this.x, this.y, t1, t1);
    }
  },
  Driller: {
  ...
  Oildriller: {
    "^": "Driller;tox,direction,nextDirection,sheet,world,price,drilltime,tickcount,level,x,y,dead",
    render$1: function(ctx) {
      this.sheet.renderVariableTile$6(ctx, this.x, this.y, 4, 32, 1);
    }
  },
  Mouse: {
    "^": "Object;x>,y,rx,ry,tilesize"
  },
  Game: {
    "^": "Object;canvas,tilelayer,ctx,tilectx,title,lastTime,unprocessedFrames,world,sheet,state,pause,renderNormalCursor,nnumbers,mouse,scrollY,scroll,selection,tickcount",
    start$0: function(_) {
      var image, t1, t2;
      image = W.ImageElement_ImageElement(null, null, null);
      t1 = J.getInterceptor$x(image);
      t2 = t1.get$onLoad(image);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.Game_start_closure(this, image)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.set$src(image, "tile.png");
    },
    loop$1: [function(_, time) {
      var now, e, t1, t2, t3, t4, t5, t6, t7, t8, scale, exception;
      try {
        t1 = Date.now();
        new P.DateTime(t1, false).DateTime$_now$0();
        now = t1;
        t1 = this.unprocessedFrames + J.$sub$n(now, this.lastTime) * 60 / 1000;
        this.unprocessedFrames = t1;
        this.lastTime = now;
        if (t1 > 10) {
          this.unprocessedFrames = 10;
          t1 = 10;
        }
        for (; t1 > 1;) {
          this.tickcount = this.tickcount + 1;
          if (this.state === 1) {
            t1 = this.scrollY + this.scroll;
            this.scrollY = t1;
            if (t1 >= 0) {
              this.scrollY = 0;
              t1 = 0;
            ...
            t2.toString;
            t2.scrollY = -1 * C.JSNumber_methods.toInt$0(Math.ceil(t1 / 32));
            if (!this.pause)
              this.world.tick$0();
          }
          t1 = this.unprocessedFrames - 1;
          this.unprocessedFrames = t1;
        }
        if (this.state === 1) {
          t1 = this.canvas;
          t2 = J.getInterceptor$x(t1);
          J.clearRect$4$x(this.ctx, 0, 0, t2.get$width(t1), t2.get$height(t1));
          t3 = this.tilectx;
          t4 = -this.scrollY;
          J.clearRect$4$x(t3, 0, t4, 640, 480 + t4);
          this.world.render$5(this.tilectx, 0, 0, 20, 18);
          this.world.renderEntities$1(this.tilectx);
          if (!this.renderNormalCursor) {
            ...
            t3.toString;
            t8 = t3.sheet;
            t8 = C.JSNumber_methods.toInt$0(Math.floor(t6 / t8.tilesize / t8.scale));
            t6 = t3.sheet;
            t6 = C.JSNumber_methods.toInt$0(Math.floor((t5 - t7) / t6.tilesize / t6.scale));
            t3.sheet.renderVariableTile$6(t4, t8 * 32, t6 * 32, 4, 32, 1);
          }
          J.drawImage$3$x(this.ctx, this.tilelayer, 0, this.scrollY);
          this.drawNumberString$4(C.JSNumber_methods.toString$0(this.world.money), this.ctx, 10, 10);
          if (this.pause) {
            J.set$fillStyle$x(this.ctx, "#2f1c0b");
            ...
            if (typeof t1 !== "number")
              return t1.$sub();
            J.fillText$3$x(t3, "Paused", t1 - 30, 40);
          }
        }
        if (this.state === 3) {
          t1 = this.canvas;
          t2 = J.getInterceptor$x(t1);
          J.clearRect$4$x(this.ctx, 0, 0, t2.get$width(t1), t2.get$height(t1));
          J.set$fillStyle$x(this.ctx, "#000");
          J.fillRect$4$x(this.ctx, 0, 0, t2.get$width(t1), t2.get$height(t1));
          t1 = this.ctx;
          t2 = this.title;
          J.drawImageScaledFromSource$9$x(t1, t2, 0, 0, J.get$width$x(t2), 26, 20, 40, 600, 100);
          J.set$fillStyle$x(this.ctx, "#b86f29");
          J.set$font$x(this.ctx, "30px Arial");
          J.set$textAlign$x(this.ctx, "left");
          J.fillText$3$x(this.ctx, "Thank you for playing my game :)", 60, 200);
          J.fillText$3$x(this.ctx, "You made " + C.JSNumber_methods.toString$0(this.world.money) + " out of " + C.JSInt_methods.toString$0(this.world.totalValue - 10) + "$", 60, 250);
          J.fillText$3$x(this.ctx, "Press Space to restart", 60, 300);
        }
        if (this.state === 0) {
          t1 = this.canvas;
          t2 = J.getInterceptor$x(t1);
          ...
          if (typeof t3 !== "number")
            return t3.$sub();
          J.drawImageScaledFromSource$9$x(t1, t2, 0, 30, t4, t3 - 26, 20, 170, 600 + scale, 100 + scale);
        }
        t1 = window;
    ...
    }, "call$1", "get$loop", 2, 0, 19],
    drawNumberString$4: function(input, ctx, posx, posy) {
      var start, t1, t2, i;
      this.sheet.renderTile$4(ctx, posx, posy, 56);
      start = posx + 32;
      for (t1 = input.length, t2 = this.nnumbers, i = 0; i < t1; ++i) {
        this.sheet.renderVariableTile$6(ctx, start, posy, C.JSString_methods.indexOf$1(t2, input[i]) + 240 + 2, 8, 4);
        start += 32;
      }
    },
    Game$1: function(canvas) {
      var t1, t2, e;
      t1 = this.canvas;
      t2 = J.getInterceptor$x(t1).getContext$1(t1, "2d");
      this.ctx = t2;
      J.set$imageSmoothingEnabled$x(t2, false);
      this.mouse = new G.Mouse(0, 0, 0, 0, 32);
      C.CanvasElement_methods.addEventListener$2(t1, "mousemove", new G.Game_closure(this));
      C.CanvasElement_methods.addEventListener$2(t1, "click", new G.Game_closure0(this));
      C.CanvasElement_methods.addEventListener$2(t1, "mousemove", new G.Game_closure1(this));
      J.addEventListener$2$x(document.body, "keyup", new G.Game_closure2(this));
      J.addEventListener$2$x(document.body, "keydown", new G.Game_closure3(this));
      e = document.createElement("canvas", null);
      this.tilelayer = e;
      J.set$width$x(e, 640);
      J.set$height$x(this.tilelayer, 4096);
      t1 = J.getContext$1$x(this.tilelayer, "2d");
      this.tilectx = t1;
      J.set$imageSmoothingEnabled$x(t1, false);
    },
    static: {"^": "Game_WORLD_WIDTH,Game_WORLD_HEIGHT,Game_SCROLLSPEED,Game_STATE_PLAYSCREEN,Game_STATE_PLAY,Game_STATE_RESET,Game_STATE_PLAYEND", Game$: function(canvas) {
        var t1 = Date.now();
        new P.DateTime(t1, false).DateTime$_now$0();
        t1 = new G.Game(canvas, null, null, null, null, t1, 0, null, null, 0, false, true, "1234567890", null, 0, 0, -1, 0);
        t1.Game$1(canvas);
        return t1;
      }}
  },
  Game_closure: {
    ...
    call$1: function(e) {
      ...
      if (typeof t5 !== "number")
        return t5.$sub();
      if (t2.isBuildable$2(t4, t5 - t6) && t1.state === 1) {
        t2 = t1.mouse;
        t4 = t3.get$offset(e);
        t2.rx = t4.get$x(t4);
        t4 = t1.mouse;
        t3 = t3.get$offset(e);
        t4.ry = t3.get$y(t3);
        t1.renderNormalCursor = false;
        return;
      }
      t1.renderNormalCursor = true;
    }
  },
  Game_closure0: {
    "^": "Closure:20;this_1",
    call$1: function(e) {
      ...
      if (typeof t5 !== "number")
        return t5.$sub();
      if (t2.clickOnDrillerEnd$2(t4, t5 - t6) && t1.state === 1)
        return;
      t2 = t1.world;
      t4 = t3.get$offset(e);
      t4 = t4.get$x(t4);
      ...
      if (t2.isBuildable$2(t4, t5 - t6) && t1.state === 1) {
        ...
        if (!(t2.money - 10 < 0)) {
          ...
          t2.toString;
          t6 = t2.sheet;
          C.JSNumber_methods.toInt$0(Math.floor(t4 / t6.tilesize / t6.scale));
          t6 = t2.sheet;
          t6 = C.JSNumber_methods.toInt$0(Math.floor((t3 - t5) / t6.tilesize / t6.scale));
          t5 = t2.drillers;
          t6 = new G.Oildriller(0, 0, 0, t2.sheet, t2, 0, 0, 0, 0, t4, t6 * 32, false);
          t6.price = 10;
          t6.drilltime = 120;
          t5.push(t6);
          t2 = $.get$Sample_done();
  ...
  Game_closure1: {
    ...
    call$1: function(e) {
      ...
      if (typeof t4 !== "number")
        return t4.$div();
      t2.x = C.JSNumber_methods.toInt$0(Math.floor(t4 / t5)) * t5;
      if (typeof t3 !== "number")
        return t3.$sub();
      t2.y = C.JSNumber_methods.toInt$0(Math.floor((t3 - t1) / 32)) * 32;
    }
  },
  Game_closure2: {
    "^": "Closure:21;this_3",
    call$1: function(e) {
      ...
      if (J.get$keyCode$x(e) === 32) {
        ...
        if (t2 === 3) {
          ...
          t2.money = 10;
          t2.totalValue = 0;
          t2.drillends.clear$0(0);
          t2.tiles = Array(t2.w * t2.h);
          C.JSArray_methods.set$length(t2.drillers, 0);
          C.JSArray_methods.set$length(t2.emitters, 0);
          t2.diamonds.clear$0(0);
          t2.generateWorld$0();
          t1.state = 1;
        }
      }
      t1 = e.keyCode;
      if ((t1 === 40 || t1 === 83) && this.this_3.state === 1)
        this.this_3.scroll = 0;
      t1 = e.keyCode;
      if ((t1 === 38 || t1 === 87) && this.this_3.state === 1)
        this.this_3.scroll = 0;
    }
  },
  Game_closure3: {
    ...
    call$1: function(e) {
      var t1;
      if ((J.get$keyCode$x(e) === 40 || e.keyCode === 83) && this.this_4.state === 1) {
        t1 = this.this_4;
        t1.scroll = -12;
        t1.renderNormalCursor = true;
      }
      t1 = e.keyCode;
      if ((t1 === 38 || t1 === 87) && this.this_4.state === 1) {
        t1 = this.this_4;
        t1.scroll = 12;
        t1.renderNormalCursor = true;
      }
  ...
  Game_start_closure: {
    "^": "Closure:7;this_0,image_1",
    call$1: function(e) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = this.image_1;
      t3 = new G.Tilesheet(t2, 16, null, null, 2);
      t3.Tilesheet$3(t2, 16, 2);
      t1.sheet = t3;
      t2 = P._Random$(1222377771217);
      t2 = new G.World(t1, 20, 128, 0, null, null, t3, null, t2, 10, 0, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2.World$4(t3, 20, 128, t1);
      t1.world = t2;
      t2 = W.ImageElement_ImageElement(null, null, null);
      t1.title = t2;
      t2 = J.get$onLoad$x(t2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.Game_start__closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      J.set$src$x(t1.title, "title.png");
    }
  },
  Game_start__closure: {
    "^": "Closure:7;this_2",
  ...
  Sample: {
    "^": "Object;loaded,request,buffer',path",
    load$0: function(_) {
      var e, t1, exception;
      try {
        ...
        t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_load0._eventType, false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$sampleLoaded()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        J.open$3$async$x(this.request, "GET", this.path, true);
        this.request.send();
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
    ...
    sampleLoaded$1: [function(e) {
      J.decodeAudioData$1$x($.Sample_context, W._convertNativeToDart_XHR_Response(this.request.response)).then$1(new G.Sample_sampleLoaded_closure(this));
    }, "call$1", "get$sampleLoaded", 2, 0, 22],
    play$0: function(_) {
      var sourceNode, e, exception, t1;
      if (!this.loaded || $.Sample_soundFailed || !$.Sample_soundOn)
        return;
      try {
        sourceNode = $.Sample_context.createBufferSource();
        J._connect$3$x(sourceNode, $.Sample_gainNode, 0, 0);
        J.set$buffer$x(sourceNode, this.buffer);
        J.noteOn$1$x(sourceNode, 0);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
        P.print(e);
        $.Sample_soundFailed = true;
      }

    },
    static: {"^": "Sample_context,Sample_gainNode,Sample_explode,Sample_collision,Sample_move,Sample_done,Sample_pickup,Sample_soundFailed,Sample_soundOn", Sample_init: function() {
        var e, t1, exception;
        try {
          t1 = new (window.AudioContext || window.webkitAudioContext)();
          $.Sample_context = t1;
          t1 = t1.createGainNode();
          $.Sample_gainNode = t1;
          t1.connect($.Sample_context.destination, 0, 0);
          $.get$Sample_explode().load$0(0);
          $.get$Sample_collision().load$0(0);
          $.get$Sample_move().load$0(0);
          $.get$Sample_done().load$0(0);
          $.get$Sample_pickup().load$0(0);
        } catch (exception) {
          t1 = H.unwrapException(exception);
          e = t1;
          P.print(e);
  ...
  Tilesheet: {
    "^": "Object;img,tilesize,tilesx,tilesy,scale",
    renderTile$4: function(ctx, posx, posy, index) {
      var t1, t2, t3, tx, ty, x, tx0, y;
      for (t1 = this.tilesx, t2 = this.tilesy, t3 = this.tilesize, tx = 0, ty = 0, x = 0; x < t1; ++x)
        for (tx0 = x * t3, y = 0; y < t2; ++y)
          if (x + y * t1 === index) {
            ty = y * t3;
            tx = tx0;
          }
      t1 = t3 * this.scale;
      J.drawImageScaledFromSource$9$x(ctx, this.img, tx, ty, t3, t3, posx, posy, t1, t1);
    },
    renderVariableTile$6: function(ctx, posx, posy, index, tilesize, scale) {
      var t1, t2, t3, tsx, tsy, tx, ty, x, tx0, y;
      t1 = this.img;
      t2 = J.getInterceptor$x(t1);
      t3 = t2.get$width(t1);
      if (typeof t3 !== "number")
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      tsy = t2 / tilesize;
      for (t2 = tilesize * scale, t3 = J.getInterceptor$x(ctx), tx = 0, ty = 0, x = 0; x < tsx; ++x) {
        for (tx0 = x * tilesize, y = 0; y < tsy; ++y)
          if (x + y * tsx === index) {
            ty = y * tilesize;
            tx = tx0;
          }
        t3.drawImageScaledFromSource$9(ctx, t1, tx, ty, tilesize, tilesize, posx, posy, t2, t2);
      }
    },
    Tilesheet$3: function(img, tilesize, scale) {
      var t1, t2, t3, t4;
      t1 = this.img;
      t2 = J.getInterceptor$x(t1);
      t3 = t2.get$width(t1);
  ...
  DrillEnd: {
    "^": "Object;index>,direction<,dead@"
  },
  World: {
    "^": "Object;game,w,h,totalValue,tiles,drillers,sheet,emitters,r,money,scrollY,diamonds,drillends",
    generateWorld$0: function() {
      var t1, t2, t3, t4, t5, t6, y, t7, t8, t9, t10, t11, t12, x, t13, t14, yesorno, t15;
      for (t1 = this.h, t2 = this.w, t3 = this.r, t4 = t1 - 1, t5 = t1 - t1 / 2, t6 = this.diamonds, y = 0; y < t1; ++y)
        for (t7 = y * t2, t8 = y > 5, t9 = y === t4, t10 = y === 5, t11 = y < 5, t12 = y < t5, x = 0; x < t2; ++x) {
          if (t11) {
            t13 = this.tiles;
            t14 = C.JSInt_methods.toInt$0(x + t7);
          ...
          if (t8 && t12) {
            yesorno = t3.nextInt$1(40);
            if (yesorno === 4 || yesorno === 1) {
              t13 = this.tiles;
              t14 = x + t7;
              t15 = C.JSInt_methods.toInt$0(t14);
              if (t15 < 0 || t15 >= t13.length)
                return H.ioore(t13, t15);
              t13[t15] = 7;
              t6.$indexSet(0, C.JSInt_methods.toInt$0(t14), new G.Diamond(2));
              this.totalValue = this.totalValue + 2;
            }
            if (yesorno === 12) {
              t13 = this.tiles;
              t14 = x + t7;
              ...
              if (t15 < 0 || t15 >= t13.length)
                return H.ioore(t13, t15);
              t13[t15] = 15;
              t6.$indexSet(0, C.JSInt_methods.toInt$0(t14), new G.Diamond(4));
              this.totalValue = this.totalValue + 4;
              continue;
            }
          ...
          if (yesorno === 1 || yesorno === 2) {
            ...
            if (t15 < 0 || t15 >= t13.length)
              return H.ioore(t13, t15);
            t13[t15] = 4;
            t6.$indexSet(0, C.JSInt_methods.toInt$0(t14), new G.Diamond(5));
          ...
          if (yesorno === 18) {
            ...
            if (t15 < 0 || t15 >= t13.length)
              return H.ioore(t13, t15);
            t13[t15] = 6;
            t6.$indexSet(0, C.JSInt_methods.toInt$0(t14), new G.Diamond(10));
    ...
    render$5: function(ctx, posx, posy, w, h) {
      var t1, hs, sy, t2, y, x, t3, t4, t5, t6, t7, t8, t9;
      t1 = this.scrollY;
      hs = h + t1;
      sy = posy + t1;
      for (t1 = this.h, t2 = J.getInterceptor$x(ctx), y = sy; y < hs; ++y)
        for (x = C.JSInt_methods.toInt$0(posx), t3 = y * w, t4 = y >= t1; x < w; ++x) {
          if (t4)
            continue;
          t5 = this.tiles;
          t6 = x + t3;
          ...
          if (t5 === -1) {
            ...
            t5 = t5.tilesize;
            t7 = t6 * t5;
            ctx.fillRect(x * t6 * t5, y * t6 * t5, t7, t7);
            continue;
          }
          if (t5 === 999) {
            t2.set$fillStyle(ctx, "#F0F");
            t5 = this.sheet;
            t7 = t5.scale;
            t5 = t5.tilesize;
            t8 = t7 * t5;
            ctx.fillRect(x * t7 * t5, y * t7 * t5, t8, t8);
          }
          t5 = this.sheet;
          t7 = t5.scale;
          t8 = t5.tilesize;
          ...
          t5.renderTile$4(ctx, x * t7 * t8, y * t7 * t8, t9[t6]);
        }
    },
    renderEntities$1: function(ctx) {
      var i, t1, d;
      for (i = 0; t1 = this.drillers, i < t1.length; ++i) {
        d = t1[i];
        d.sheet.renderVariableTile$6(ctx, d.x, d.y, 4, 32, 1);
      }
      for (t1 = this.emitters, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.render$1(ctx);
    },
    tick$0: function() {
      var i, t1, t2, p, i0, d;
      for (i = 0; t1 = this.emitters, t2 = t1.length, i < t2; ++i) {
        if (i < 0)
          return H.ioore(t1, i);
        p = t1[i];
        p.tick$0();
        if (p.ld29$ParticleEmitter$dead) {
          i0 = i - 1;
          C.JSArray_methods.removeAt$1(this.emitters, i);
          i = i0;
        }
      }
      for (i = 0; t1 = this.drillers, i < t1.length; ++i) {
        ...
        if (!d.dead) {
          t1 = d.tickcount + 1;
          d.tickcount = t1;
          if (C.JSInt_methods.$mod(t1, d.drilltime) === 0) {
            t1 = d.nextDirection;
            d.direction = t1;
            if (t1 === 0) {
              t1 = d.level + 1;
              d.level = t1;
              d.world.drillDown$4(d, d.x + d.tox * 32, d.y + t1 * 32, 3);
            }
            if (d.direction === 1) {
              t1 = d.tox - 1;
              d.tox = t1;
              d.world.drillLeft$4(d, d.x + t1 * 32, d.y + d.level * 32, 12);
            }
            if (d.direction === 2) {
              t1 = d.tox + 1;
              d.tox = t1;
    ...
    drillDown$4: function(src, posx, posy, index) {
      var x, y, t1, t2;
      x = C.JSNumber_methods.toInt$0(Math.floor(posx / 32));
      y = C.JSNumber_methods.toInt$0(Math.floor(posy / 32));
      if (this.doesCollide$2(x, y)) {
        src.dead = true;
        this.drillends.$index(0, src).set$dead(true);
        t1 = $.get$Sample_collision();
        if (t1.loaded)
          t1.play$0(0);
        if (this.isBedrock$2(x, y))
          this.game.state = 3;
        if (this.checkForGameEnd$0())
          this.game.state = 3;
        return;
      }
      this.getDiamond$2(x, y);
      t1 = this.tiles;
      t2 = x + y * this.w;
      if (t2 < 0 || t2 >= t1.length)
        return H.ioore(t1, t2);
      t1[t2] = index;
      this.drillends.$indexSet(0, src, new G.DrillEnd(t2, 0, false));
      this.emitters.push(G.ParticleEmitter$(x * 32 + 16, y * 32 + 16, 200));
      t1 = $.get$Sample_explode();
      if (t1.loaded)
        t1.play$0(0);
    },
    isBedrock$2: function(x, y) {
      var t1, t2;
      t1 = this.tiles;
      t2 = x + y * this.w;
      if (t2 < 0 || t2 >= t1.length)
    ...
    getDiamond$2: function(x, y) {
      ...
      if (t1.containsKey$1(t2)) {
        ...
        this.money = t3 + t4;
        t1.remove$1(0, t2);
        t1 = $.get$Sample_pickup();
        if (t1.loaded)
          t1.play$0(0);
      }
    },
    drillLeft$4: function(src, posx, posy, index) {
      var x, y, t1, t2;
      x = C.JSNumber_methods.toInt$0(Math.floor(posx / 32));
      y = C.JSNumber_methods.toInt$0(Math.floor(posy / 32));
      if (this.doesCollide$2(x, y)) {
      ...
      if (t2 < 0 || t2 >= t1.length)
        return H.ioore(t1, t2);
      t1[t2] = index;
      this.drillends.$indexSet(0, src, new G.DrillEnd(t2, 1, false));
      this.emitters.push(G.ParticleEmitter$(x * 32 + 16, y * 32 + 16, 200));
      t1 = $.get$Sample_explode();
      if (t1.loaded)
        t1.play$0(0);
    },
    clickOnDrillerEnd$2: function(posx, posy) {
      var t1, t2, x, index, t3, driller, d;
      t1 = this.sheet;
      t2 = t1.tilesize;
      if (typeof posx !== "number")
        return posx.$div();
      x = C.JSNumber_methods.toInt$0(Math.floor(posx / t2 / t1.scale));
      t1 = this.sheet;
      index = x + C.JSNumber_methods.toInt$0(Math.floor(posy / t1.tilesize / t1.scale)) * this.w;
      for (t1 = this.drillends, t2 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(t1), [H.getTypeArgumentByIndex(t1, 0)])._map, t3 = new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), t3._cell = t2._first; t3.moveNext$0();) {
        driller = t3._collection$_current;
        d = t1.$index(0, driller);
        if (J.get$index$x(d) === index) {
          if (d.get$dead())
            return false;
          t1 = this.getNextDirection$2(driller.get$direction(), d.direction);
          d.direction = t1;
          t2 = this.tiles;
          t1 = this.getNextTile$2(driller.get$direction(), t1);
          if (index < 0 || index >= t2.length)
            return H.ioore(t2, index);
          t2[index] = t1;
          driller.set$nextDirection(d.direction);
          t1 = $.get$Sample_move();
          if (t1.loaded)
            t1.play$0(0);
          return true;
    ...
    getNextDirection$2: function(now, dir) {
      if (now === 0) {
        if (dir === 0)
          return 1;
        if (dir === 1)
    ...
    getNextTile$2: function(now, dir) {
      if (now === 0) {
        if (dir === 1)
          return 19;
        if (dir === 2)
    ...
    isBuildable$2: function(posx, posy) {
      var t1, t2, x, y;
      t1 = this.sheet;
      t2 = t1.tilesize;
      if (typeof posx !== "number")
      ...
      x = C.JSNumber_methods.toInt$0(Math.floor(posx / t2 / t1.scale));
      t1 = this.sheet;
      y = C.JSNumber_methods.toInt$0(Math.floor(posy / t1.tilesize / t1.scale));
      if (y > this.h)
        return false;
      t1 = this.tiles;
      t2 = x + y * this.w;
      if (t2 < 0 || t2 >= t1.length)
        return H.ioore(t1, t2);
      if (t1[t2] === 2 && y === 4) {
        for (t1 = this.drillers, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = x * 32; t1.moveNext$0();)
          if (J.get$x$x(t1._current) === t2)
            return false;
        return true;
      }
      return false;
    },
    checkForGameEnd$0: function() {
      var t1, deadcounter;
      for (t1 = this.drillers, t1 = new H.ListIterator(t1, t1.length, 0, null), deadcounter = 0; t1.moveNext$0();)
        if (t1._current.get$dead())
          ++deadcounter;
      if (deadcounter === this.drillers.length && this.money < 10)
        return true;
      return deadcounter === this.w;
    },
    World$4: function(sheet, w, h, game) {
      this.tiles = Array(C.JSInt_methods.toInt$0(this.w * this.h));
      this.emitters = [];
      this.drillers = [];
      this.generateWorld$0();
    },
    static: {"^": "World_TILE_BEDROCK,World_TILE_PIPELEFTORRIGHT,World_TILE_PIPEDOWN,World_TILE_PIPEDOWNRIGHT,World_TILE_PIPEDOWNLEFT,World_TILE_ROCK,World_TILE_BIGDIAMOND,World_TILE_BIGSAPHIRE,World_TILE_SMALLSAPHIRE,World_TILE_SMALLDIAMOND"}
  }
},
1],
]);
...
$.Sample_context = null;
$.Sample_gainNode = null;
$.Sample_soundFailed = false;
$.Sample_soundOn = true;
...
Isolate.$lazy($, "explode", "Sample_explode", "get$Sample_explode", function() {
  return new G.Sample(false, null, null, "sound/explosion.wav");
});
Isolate.$lazy($, "collision", "Sample_collision", "get$Sample_collision", function() {
  return new G.Sample(false, null, null, "sound/collision.wav");
});
Isolate.$lazy($, "move", "Sample_move", "get$Sample_move", function() {
  return new G.Sample(false, null, null, "sound/move.wav");
});
Isolate.$lazy($, "done", "Sample_done", "get$Sample_done", function() {
  return new G.Sample(false, null, null, "sound/done.wav");
});
Isolate.$lazy($, "pickup", "Sample_pickup", "get$Sample_pickup", function() {
  return new G.Sample(false, null, null, "sound/pickup.wav");
});
// Native classes
...
{func: "void__ProgressEvent", void: true, args: [W.ProgressEvent]},
];
$ = null;
...
function dart_precompiled($collectedClasses) {
  ...
  AudioBufferSourceNode.prototype.set$buffer = function(receiver, v) {
    return receiver.buffer = v;
  };
  ...
  Entity.prototype.get$dead = function() {
    return this.dead;
  };
  Entity.prototype.set$dead = function(v) {
    return this.dead = v;
  };
  function ParticleEmitter(particles, r, ld29$ParticleEmitter$dead, deadcount, x, y, dead) {
    this.particles = particles;
    this.r = r;
    this.ld29$ParticleEmitter$dead = ld29$ParticleEmitter$dead;
  ...
  ParticleEmitter.prototype.get$dead = function() {
    return this.ld29$ParticleEmitter$dead;
  };
  ParticleEmitter.prototype.set$dead = function(v) {
    return this.ld29$ParticleEmitter$dead = v;
  };
  function Particle(tickcount, velocityY, velocityX, ld29$Particle$dead, size, x, y, dead) {
    this.tickcount = tickcount;
    this.velocityY = velocityY;
    this.velocityX = velocityX;
    this.ld29$Particle$dead = ld29$Particle$dead;
    this.size = size;
    this.x = x;
    this.y = y;
    this.dead = dead;
  ...
  Particle.prototype.get$dead = function() {
    return this.ld29$Particle$dead;
  };
  Particle.prototype.set$dead = function(v) {
    return this.ld29$Particle$dead = v;
  };
  function Driller(direction, nextDirection) {
    this.direction = direction;
    this.nextDirection = nextDirection;
  }
  Driller.builtin$cls = "Driller";
  if (!"name" in Driller)
    Driller.name = "Driller";
  $desc = $collectedClasses.Driller;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Driller.prototype = $desc;
  Driller.prototype.get$direction = function() {
    return this.direction;
  };
  Driller.prototype.set$nextDirection = function(v) {
    return this.nextDirection = v;
  };
  function Oildriller(tox, direction, nextDirection, sheet, world, price, drilltime, tickcount, level, x, y, dead) {
    this.tox = tox;
    this.direction = direction;
    this.nextDirection = nextDirection;
    this.sheet = sheet;
  ...
  Oildriller.builtin$cls = "Oildriller";
  if (!"name" in Oildriller)
    Oildriller.name = "Oildriller";
  $desc = $collectedClasses.Oildriller;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Oildriller.prototype = $desc;
  function Mouse(x, y, rx, ry, tilesize) {
    this.x = x;
    this.y = y;
    this.rx = rx;
    this.ry = ry;
  ...
  function Game(canvas, tilelayer, ctx, tilectx, title, lastTime, unprocessedFrames, world, sheet, state, pause, renderNormalCursor, nnumbers, mouse, scrollY, scroll, selection, tickcount) {
    this.canvas = canvas;
    ...
    this.unprocessedFrames = unprocessedFrames;
    this.world = world;
    this.sheet = sheet;
    this.state = state;
    this.pause = pause;
    this.renderNormalCursor = renderNormalCursor;
  ...
  function Game_closure2(this_3) {
    this.this_3 = this_3;
  }
  Game_closure2.builtin$cls = "Game_closure2";
  if (!"name" in Game_closure2)
    Game_closure2.name = "Game_closure2";
  $desc = $collectedClasses.Game_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_closure2.prototype = $desc;
  function Game_closure3(this_4) {
    this.this_4 = this_4;
  }
  Game_closure3.builtin$cls = "Game_closure3";
  if (!"name" in Game_closure3)
    Game_closure3.name = "Game_closure3";
  $desc = $collectedClasses.Game_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_closure3.prototype = $desc;
  function Game_start_closure(this_0, image_1) {
    this.this_0 = this_0;
  ...
  function Game_start__closure(this_2) {
    this.this_2 = this_2;
  }
  ...
  function Sample(loaded, request, buffer, path) {
    this.loaded = loaded;
  ...
  Sample.prototype.set$buffer = function(receiver, v) {
    return this.buffer = v;
  };
  function Sample_sampleLoaded_closure(this_0) {
    this.this_0 = this_0;
  }
  Sample_sampleLoaded_closure.builtin$cls = "Sample_sampleLoaded_closure";
  if (!"name" in Sample_sampleLoaded_closure)
    Sample_sampleLoaded_closure.name = "Sample_sampleLoaded_closure";
  $desc = $collectedClasses.Sample_sampleLoaded_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Sample_sampleLoaded_closure.prototype = $desc;
  function Tilesheet(img, tilesize, tilesx, tilesy, scale) {
    this.img = img;
    this.tilesize = tilesize;
    this.tilesx = tilesx;
    this.tilesy = tilesy;
  ...
  Tilesheet.builtin$cls = "Tilesheet";
  if (!"name" in Tilesheet)
    Tilesheet.name = "Tilesheet";
  $desc = $collectedClasses.Tilesheet;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tilesheet.prototype = $desc;
  function Diamond(value) {
    this.value = value;
  }
  Diamond.builtin$cls = "Diamond";
  if (!"name" in Diamond)
    Diamond.name = "Diamond";
  $desc = $collectedClasses.Diamond;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Diamond.prototype = $desc;
  Diamond.prototype.get$value = function(receiver) {
    return this.value;
  };
  function DrillEnd(index, direction, dead) {
    this.index = index;
    this.direction = direction;
    this.dead = dead;
  }
  DrillEnd.builtin$cls = "DrillEnd";
  if (!"name" in DrillEnd)
    DrillEnd.name = "DrillEnd";
  $desc = $collectedClasses.DrillEnd;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrillEnd.prototype = $desc;
  DrillEnd.prototype.get$index = function(receiver) {
    return this.index;
  };
  DrillEnd.prototype.get$direction = function() {
    return this.direction;
  };
  DrillEnd.prototype.get$dead = function() {
    return this.dead;
  };
  DrillEnd.prototype.set$dead = function(v) {
    return this.dead = v;
  };
  function World(game, w, h, totalValue, tiles, drillers, sheet, emitters, r, money, scrollY, diamonds, drillends) {
    this.game = game;
    this.w = w;
    this.h = h;
    this.totalValue = totalValue;
    this.tiles = tiles;
    this.drillers = drillers;
    this.sheet = sheet;
